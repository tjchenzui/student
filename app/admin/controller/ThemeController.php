    ...
    public function dataSource()
    {
        ...
        if (isset($dataSource['filters']) && is_array($dataSource['filters'])) {
            ...
            foreach ($filters as $key => $filter) {
                if ($filter['type'] == 'xuanzheti' && !empty($filter['api'])) {
                    $filterData = [];
                    try {
        ...
        $tpl = "<tr class='data-item-tr'>
					<td>
                        <input type='radio' class='js-xuanzheti-box' 
                           name='ids[]'
        ...
        if ($multi) {
            $tpl = "<tr class='data-item-tr'>
					<td>
					    <input type='checkbox' class='js-check js-xuanzheti-box' data-yid='js-check-y'
                                   data-xid='js-check-x'
                                   name='ids[]'
                                   value='\$id' data-name='\$name' \$checked>
					</td>
