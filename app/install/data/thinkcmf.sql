...
CREATE TABLE IF NOT EXISTS `cmf_theme_file` (
  ...
  `file` varchar(50) NOT NULL DEFAULT '' COMMENT '模板文件，相对于模板根目录，如Portal/indextikude.html',
