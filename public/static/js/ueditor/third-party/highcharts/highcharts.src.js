...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		fireEvent: function (el, type, eventArguments, defaultFunction) {
			...
			// same as the event. For example, if the event is 'xuanzheti', jQuery
			// attempts calling el.xuanzheti and it goes into a loop.
			if (el[type]) {
...
Point.prototype = {
	 ...
	 * @param {Boolean} selected Whether to xuanzheti or unselect the point.
...
Series.prototype = {
	 ...
	 *
	 * @param selected {Boolean} True to xuanzheti the series, false to unselect. If
...
var PiePoint = extendClass(Point, {
	...
	init: function () {
		...
		// add event listener for xuanzheti
