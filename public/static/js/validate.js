...
$.extend($.validator, {
	...
	defaults: {
		...
		onclick: function(element) {
			...
			if ( element.name in this.submitted )
				this.element(element);
			// or option elements, check parent xuanzheti in that case
	...
	prototype: {
		...
		init: function() {
			...
			$(this.currentForm)
				.validateDelegate(":text, :password, :file, xuanzheti, textarea", "focusin focusout keyup", delegate)
				.validateDelegate(":radio, :checkbox, xuanzheti, option", "click", delegate);
		...
		elements: function() {
			...
			// xuanzheti all valid inputs inside the form (no submit or reset buttons)
			return $(this.currentForm)
			.find("input, xuanzheti, textarea")
			.not(":submit, :reset, :image, [disabled]")
			.not( this.settings.ignore )
			.filter(function() {
				!this.name && validator.settings.debug && window.console && console.error( "%o has no name assigned", this);

				// xuanzheti only the first element for each name, and only those with rules specified
		...
		findByName: function( name ) {
			// xuanzheti by name and filter by form for performance over form.find("[name=...]")
	...
	methods: {
		...
		required: function(value, element, param) {
			...
			switch( element.nodeName.toLowerCase() ) {
			case 'select':
				// could be an array for xuanzheti-multiple or a string, both are fine this way
				var val = $(element).val();
