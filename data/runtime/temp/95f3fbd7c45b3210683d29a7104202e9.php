<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"themes/admin_simpleboot3/admin\slide_item\index.html";i:1504866290;s:43:"themes/admin_simpleboot3/public\header.html";i:1504866290;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <table class="table table-hover table-bordered">
            ...
            <?php if(is_array($result) || $result instanceof \think\Collection || $result instanceof \think\Paginator): if( count($result)==0 ) : echo "" ;else: foreach($result as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('SlideItem/edit',array('id'=>$vo['id'])); ?>"><?php echo lang('EDIT'); ?></a>
                        <a href="<?php echo url('SlideItem/delete',array('id'=>$vo['id'])); ?>"
                           class="js-ajax-delete"><?php echo lang('DELETE'); ?></a>
                        <?php if(empty($vo['status']) == 1): ?>
                            <a href="<?php echo url('SlideItem/cancelban',array('id'=>$vo['id'])); ?>" class="js-ajax-dialog-btn"
                               data-msg="确定显示此幻灯片吗？"><?php echo lang('DISPLAY'); ?></a>
                            <?php else: ?>
                            <a href="<?php echo url('SlideItem/ban',array('id'=>$vo['id'])); ?>" class="js-ajax-dialog-btn"
