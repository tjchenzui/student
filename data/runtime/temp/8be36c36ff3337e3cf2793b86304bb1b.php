...
<style>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp59c872f7b3bec,null,false);
 ?>
</head>
...
function __parse_navigationab6209425842bdc2f57ab1101a24fc14($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigationab6209425842bdc2f57ab1101a24fc14';
...
if(''==''): ?>
    <?php echo __parse_navigationab6209425842bdc2f57ab1101a24fc14($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigationab6209425842bdc2f57ab1101a24fc14($menus); ?>
    </>
<?php endif; ?>
...
<div class="container">
 ...
 ?>
        ...
        <?php 
         ...
         $__FOR_START_31129__=1;$__FOR_END_31129__=$rows;for($row=$__FOR_START_31129__;$row <= $__FOR_END_31129__;$row+=1){ 
                $first_row = ($row-1)*3;
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp59c872f7b3c48,null,false);
 ?>
    <div class="links">
        <?php
...
<?php 
    \think\Hook::listen('before_body_end',$temp59c872f7b3c7d,null,false);
 ?>
</body>
</html>
