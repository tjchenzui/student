...
<style>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp59bc6f54e1575,null,false);
 ?>
</head>
...
function __parse_navigation61f81eefbc93f86981636a0b7cdf50a4($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation61f81eefbc93f86981636a0b7cdf50a4';
...
if(''==''): ?>
    <?php echo __parse_navigation61f81eefbc93f86981636a0b7cdf50a4($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation61f81eefbc93f86981636a0b7cdf50a4($menus); ?>
    </>
<?php endif; ?>
...
<div class="container">
 ...
 ?>
        ...
        <?php 
         ...
         $__FOR_START_24587__=1;$__FOR_END_24587__=$rows;for($row=$__FOR_START_24587__;$row <= $__FOR_END_24587__;$row+=1){ 
                $first_row = ($row-1)*3;
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp59bc6f54e15a2,null,false);
 ?>
    <div class="links">
        <?php
...
<?php 
    \think\Hook::listen('before_body_end',$temp59bc6f54e15b9,null,false);
 ?>
</body>
</html>
