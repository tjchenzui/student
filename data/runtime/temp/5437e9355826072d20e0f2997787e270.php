<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/admin\link\index.html";i:1504866290;s:43:"themes/admin_simpleboot3/public\header.html";i:1504866290;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($links) || $links instanceof \think\Collection || $links instanceof \think\Paginator): if( count($links)==0 ) : echo "" ;else: foreach($links as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('link/edit',array('id'=>$vo['id'])); ?>"><?php echo lang('EDIT'); ?></a> |
                        <a href="<?php echo url('link/delete',array('id'=>$vo['id'])); ?>" class="js-ajax-delete">
